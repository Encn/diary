<template>
  <div id="edit">
    ...
    <div class="mui-scroll-wrapper" id="scroller" style="overflow: auto;">
      <div class="content mui-scroll">
        <ul class="card" v-for="(item, indx) in list" :key="indx" :class="{'card-sel': item.active}" @click.self="topath(item.workReportCode)">
...
<style scoped lang="less">
  ...
  .content {
    ...
    .card {
      ...
      padding: 1.1rem 0 1.05rem 1.5rem;
